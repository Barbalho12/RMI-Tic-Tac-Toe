...
//	}
	...
	public static void main(String[] args) {
	    ...
	    */
	    ...
	    AlphaBetaPruning alp = new AlphaBetaPruning();
	    ...
	    for(i = 1; i <= 81; i++){
	        ...
	        if (i % 2 == 0){
	            System.out.println("Player O jogou no tabuleiro " + k + " na posicao " + alp.posmin + ". \n" );
	            input = alp.posmin;
	        }
	        ...
	        if(chktable == 1){
                ...
                if(i % 2 != 0){
                    if(i < 30){
                        opt = alp.alphabeta(k, 14, -400, 400, 2, tab, 14);
                    }
                    else if(i < 40){
                            opt = alp.alphabeta(k, 24, -400, 400, 2, tab, 24);
                        }
                    else{
                        opt = alp.alphabeta(k, 28, -400, 400, 2, tab, 28);
                    }
                }
	        }
	    }
