...
public final class GameCheck implements IBoard {
	...
	public static boolean checkValidPlay (IPlayer player, int board, int position, UltimateBoard tab, IPlayer p1, IPlayer p2) {		
	...
	public static  GameStatus checkGame (IPlayer player, UltimateBoard tab, GameControl gameCon) {		
